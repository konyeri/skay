    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('meetup_speakers', models.ManyToManyField(blank=True, null=True, to='Meetup_app.speaker')),
                ('participants', models.ManyToManyField(blank=True, null=True, to='Meetup_app.participant')),
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
